 ...
 * 
 * https://github.com/XavierBerger/pcd8544/blob/master/src/font.py
 * 
 *  Original code:
...
public class Font {
	...
	/**
	 * It seems the wiringPiSPIDataRW clears the data in the buffer so we copy it to a 
	 * temporary storage...
	 */
	static byte[] returnBuffer = new byte[5];
